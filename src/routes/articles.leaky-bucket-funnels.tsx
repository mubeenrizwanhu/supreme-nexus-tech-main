...
function LeakyBucketArticle() {
  ...
  return (
    <div className="min-h-screen bg-[#020202] text-white selection:bg-cyan-500/30 overflow-x-hidden relative pb-28">
      ...
      {/* Background Ambience */}
      <div className="absolute top-[10%] left-[-15%] w-[40%] h-[40%] bg-cyan-500/5 rounded-full blur-[150px] pointer-events-none" />
      <div className="absolute bottom-[20%] right-[-15%] w-[40%] h-[40%] bg-purple-500/5 rounded-full blur-[150px] pointer-events-none" />
      ...
      <header className="pt-32 pb-16 md:pt-40 md:pb-24 max-w-4xl mx-auto px-5 md:px-8 text-left relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-cyan-500/10 border border-cyan-500/20 px-4 py-1 rounded-full mb-6">
            <span className="text-[10px] font-mono font-bold tracking-[0.18em] text-cyan-400 uppercase">FUNNEL AUDITING</span>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-6 border-y border-white/5 py-4 text-sm text-white/40 font-mono">
            ...
            <div className="flex items-center gap-1.5">
              <Clock className="w-4 h-4 text-[color:var(--primary)]" />
      ...
      <main className="max-w-4xl mx-auto px-5 md:px-8 relative z-10">
        ...
        >
          <p className="text-lg md:text-xl text-white/80 leading-relaxed font-light italic mb-10 border-l-2 border-cyan-500/40 pl-6">
          ...
          <div className="my-10 overflow-x-auto rounded-2xl border border-white/5 bg-surface/20 backdrop-blur-md">
            <table className="w-full text-left border-collapse text-sm">
              <thead>
                <tr className="border-b border-white/10 bg-white/5">
                  <th className="p-4 font-mono font-bold text-white/80">Funnel Metric</th>
                  <th className="p-4 font-mono font-bold text-red-400">High-Friction Funnels</th>
                  <th className="p-4 font-mono font-bold text-cyan-400">Conversion-Engineered Systems</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-white/5">
                <tr>
                  <td className="p-4 font-semibold text-white/90">Landing Page CVR</td>
                  <td className="p-4 text-white/60">1.2% – 2.5%</td>
                  <td className="p-4 text-white/90 font-bold">5.8% – 12.0%</td>
                </tr>
                <tr>
                  <td className="p-4 font-semibold text-white/90">Form Fields Required</td>
                  <td className="p-4 text-white/60">9 – 12 static fields</td>
                  <td className="p-4 text-white/90">4 – 5 dynamic fields</td>
                </tr>
                <tr>
                  <td className="p-4 font-semibold text-white/90">Initial Response Speed</td>
                  <td className="p-4 text-white/60">Average 8 – 24 hours</td>
                  <td className="p-4 text-white/90 font-bold text-cyan-400">&lt; 5 minutes (automated)</td>
                </tr>
                <tr>
                  <td className="p-4 font-semibold text-white/90">SQL Conversion Lift</td>
                  <td className="p-4 text-white/60">Baseline</td>
                  <td className="p-4 text-white/90 font-bold">+184% average lift</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div className="grid gap-6 my-10 md:grid-cols-3">
            <div className="border border-white/5 bg-white/[0.02] p-6 rounded-2xl">
              <div className="flex items-center gap-2 mb-3 text-cyan-400 font-mono font-bold text-xs">
                <CheckCircle2 className="w-4 h-4 shrink-0" /> PILLAR 01
              </div>
              <h4 className="text-white font-bold mb-2">Intent Mapping</h4>
            ...
            <div className="border border-white/5 bg-white/[0.02] p-6 rounded-2xl">
              ...
              <h4 className="text-white font-bold mb-2">Progressive Profiling</h4>
              <p className="text-xs text-white/60 leading-relaxed font-light">
            ...
            <div className="border border-white/5 bg-white/[0.02] p-6 rounded-2xl">
              ...
              <h4 className="text-white font-bold mb-2">Frictionless Routing</h4>
              <p className="text-xs text-white/60 leading-relaxed font-light">
        ...
        <motion.div
          ...
          transition={{ duration: 0.6 }}
          viewport={{ once: true }}
          className="mt-20 border border-white/5 bg-gradient-to-br from-cyan-500/10 via-purple-500/5 to-transparent rounded-[3rem] p-8 md:p-12 text-center relative overflow-hidden group shadow-2xl"
        >
