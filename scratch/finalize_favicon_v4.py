...
# Path
input_path = 'public/new_favicon_source_v4.png'
...
def process():
    ...
    # Since it's 500x500 (square), it fits perfectly as 320x320
    ...
    print(f"Favicon updated with v4 source (Letters only). Scale: {scale}, Trans: ({tx}, {ty})")
